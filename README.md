🖼️ Hero Proxy Rewriter + Dashboard Pro
...
2. Buka script di raw GitHub atau salin kode dari rilis terbaru.
...
Pull request, issue, dan saran sangat diterima. Silakan buka halaman Issues untuk melaporkan bug atau meminta fitur.
